                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="section-title">
                                <h4 class="m-0 text-uppercase font-weight-bold">Tópicos sobre <?=$this->model[0]['tipo']?></h4>
                        ...
                        $titulo.=strlen($titulo_int)>50 ? '...':''; 
                            ...
                            $titulo_uri=$uri->uricategoria($tipo)[$i];
                            ...
                            <div class='bg-white border border-top-0 p-4'>
                                <div class='mb-2'>
                                    <a class='badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2'
                                        href='/categoria/$tipo/$titulo_uri'>{$this->model[$i]['tipo']}</a>
